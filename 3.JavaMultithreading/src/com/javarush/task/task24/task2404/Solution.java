...
public HasHeight castToHasHeight() {
    class App implements HasHeight { public double getHeight() { return Math.abs(point1.getY() - point2.getY()); }   }

return new App();
}

        public HasWidth castToHasWidth() {
            class App implements HasWidth { public double getWidth() { return Math.abs(point1.getX() - point2.getX()); }   }
